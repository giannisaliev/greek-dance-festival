        ...
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-blue-200 text-sm hover:text-white hover:underline">
          ...
          <button
            ...
            type="button"
            className="w-full bg-white text-gray-700 py-4 rounded-full font-bold text-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
          >
