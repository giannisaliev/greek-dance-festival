  ...
  const getFilteredStudents = () => {
    ...
    if (searchQuery) {
      ...
      filtered = filtered.filter(student => {
        const firstName = (student.participant.registrantFirstName || "").toLowerCase();
        const lastName = (student.participant.registrantLastName || "").toLowerCase();
    ...
    // Filter by package
    if (packageFilter) {
      filtered = filtered.filter(student => student.participant.packageType === packageFilter);
    }
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
                  ...
                  <div className="flex flex-col md:flex-row gap-4">
                    ...
                    {(searchQuery || packageFilter) && (
                      <button
                        ...
                        className="px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-white rounded-lg font-semibold transition-colors border border-red-500/50"
                      >
                        Clear
                      </button>
                    )}
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 overflow-hidden">
                  ...
                  {getFilteredStudents().length === 0 && (
                    <div className="text-center py-12">
                      <p className="text-blue-200 text-lg">No students found matching your filters.</p>
                    </div>
                  )}
                </div>
              </>
        ...
        {editingId && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl p-6 border border-white/20 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <h3 className="text-2xl font-bold text-white mb-6">Edit Student Registration</h3>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-white text-sm font-semibold mb-2">First Name</label>
        ...
        {deleteConfirm && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-br from-red-900 to-red-800 rounded-2xl p-6 border border-red-500/50 max-w-md w-full">
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => deleteRegistration(deleteConfirm)}
